ActionController::Routing::Routes.draw do |map|
  ...
  map.v1Stories 'login', :controller => 'login', :action => 'login'
  ...
  map.v1Stories 'search', :controller => 'search', :action => 'show'
  map.v1Stories 'error', :controller => 'search', :action => 'error'


                                                                                          
  #map.v1Stories 'v1Stories', :controller => 'show', :action => 'show'
